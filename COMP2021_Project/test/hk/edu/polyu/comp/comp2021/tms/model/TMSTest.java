...
//    private final String[][] taskCommandsAssert = {
//            {"asdoufihaoushe"},
//            {"createsimpletask weriuu"},
//            {"createcompositetask 123 49"},
//            {"createsimpletask t1 t1 3 t3"},
...
//    };
//
//    private final String[][] criteriaCommandsAssert = {
//            {"load ../data1.bin"},
//            {"definebasiccriterion c1 name contains t"},
//            {"definebasiccriterion 23408 eufoaiwe awoe8"},
//            {"definebasiccriterion c1 name contains \"n\""},
...
//     */
//    @Test
//    public void testTaskAssert() {
//        for(int i = 0; i < taskCommands.length;i++){
//            assertEquals("Invalid input command.", tms.testCommand("sdferwer"));
//        }
//    }
}